  ...
  countdown = (function (r) {
    ...
    function w(a, b, c, g, d, k) {
      ...
      try {
        ...
        !(g & 128) || b >= d
          ...
          : a.years && b++;
        !(g & 64) || b >= d
          ? (a.months && (a.days += v(a.refMonth, a.months)),
            delete a.months,
            7 <= a.days && ((a.weeks += m(a.days / 7)), (a.days %= 7)))
          : a.months && b++;
        !(g & 32) || b >= d
    ...
    function d(a, b, c, d, f) {
      ...
      "function" === typeof a
        ? ((k = a), (a = null))
        : a instanceof Date ||
          (a = null !== a && isFinite(a) ? new Date(a) : null);
      "function" === typeof b
        ? ((k = b), (b = null))
        : b instanceof Date ||
          (b = null !== b && isFinite(b) ? new Date(b) : null);
      if (!a && !b) return new n();
